...
export class AcpConnectorsService {
    /**
     ...
     * @param data.agentId
     * @param data.requestBody
     * @returns ACPConnectorPublic Successful Response
     * @throws ApiError
     */
    public static createAcpConnector(data: AcpConnectorsCreateAcpConnectorData): CancelablePromise<AcpConnectorsCreateAcpConnectorResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/agents/{agent_id}/acp-connectors',
            path: {
                agent_id: data.agentId
            },
            body: data.requestBody,
     ...
     * @param data The data for the request.
     * @param data.agentId
     * @returns ACPConnectorsPublic Successful Response
     * @throws ApiError
     */
    public static listAcpConnectors(data: AcpConnectorsListAcpConnectorsData): CancelablePromise<AcpConnectorsListAcpConnectorsResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/agents/{agent_id}/acp-connectors',
            path: {
     ...
     * @throws ApiError
     */
    public static getAcpConnector(data: AcpConnectorsGetAcpConnectorData): CancelablePromise<AcpConnectorsGetAcpConnectorResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/agents/{agent_id}/acp-connectors/{connector_id}',
            path: {
                agent_id: data.agentId,
     ...
     * @throws ApiError
     */
    public static updateAcpConnector(data: AcpConnectorsUpdateAcpConnectorData): CancelablePromise<AcpConnectorsUpdateAcpConnectorResponse> {
        return __request(OpenAPI, {
            method: 'PUT',
            url: '/api/v1/agents/{agent_id}/acp-connectors/{connector_id}',
            path: {
     ...
     * @throws ApiError
     */
    public static deleteAcpConnector(data: AcpConnectorsDeleteAcpConnectorData): CancelablePromise<AcpConnectorsDeleteAcpConnectorResponse> {
        return __request(OpenAPI, {
            method: 'DELETE',
            url: '/api/v1/agents/{agent_id}/acp-connectors/{connector_id}',
            path: {
     ...
     * @param data.connectorId
     * @param data.requestBody
     * @returns ACPTokenCreated Successful Response
     * @throws ApiError
     */
    public static createAcpToken(data: AcpConnectorsCreateAcpTokenData): CancelablePromise<AcpConnectorsCreateAcpTokenResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/agents/{agent_id}/acp-connectors/{connector_id}/tokens',
            path: {
                agent_id: data.agentId,
                connector_id: data.connectorId
            },
     ...
     * @param data.agentId
     * @param data.connectorId
     * @returns ACPTokensPublic Successful Response
     * @throws ApiError
     */
    public static listAcpTokens(data: AcpConnectorsListAcpTokensData): CancelablePromise<AcpConnectorsListAcpTokensResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/agents/{agent_id}/acp-connectors/{connector_id}/tokens',
            path: {
     ...
     * @param data.connectorId
     * @param data.tokenId
     * @returns ACPTokenPublic Successful Response
     * @throws ApiError
     */
    public static revokeAcpToken(data: AcpConnectorsRevokeAcpTokenData): CancelablePromise<AcpConnectorsRevokeAcpTokenResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/agents/{agent_id}/acp-connectors/{connector_id}/tokens/{token_id}/revoke',
            path: {
                agent_id: data.agentId,
                connector_id: data.connectorId,
                token_id: data.tokenId
     ...
     * @throws ApiError
     */
    public static deleteAcpToken(data: AcpConnectorsDeleteAcpTokenData): CancelablePromise<AcpConnectorsDeleteAcpTokenResponse> {
        return __request(OpenAPI, {
            method: 'DELETE',
            url: '/api/v1/agents/{agent_id}/acp-connectors/{connector_id}/tokens/{token_id}',
            path: {
                agent_id: data.agentId,
                connector_id: data.connectorId,
                token_id: data.tokenId
...
export class AgentsService {
     ...
     * @param data.agentId
     * @param data.name
     * @returns SkillFilesPublic Successful Response
     * @throws ApiError
     */
    public static listAgentSkillFiles(data: AgentsListAgentSkillFilesData): CancelablePromise<AgentsListAgentSkillFilesResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/agents/{agent_id}/skills/{name}/files',
            path: {
                agent_id: data.agentId,
                name: data.name
            },
