...
export class CollaborationsService {
     ...
     * @param data The data for the request.
     * @param data.requestBody
     * @returns CreateCollaborationResponse Successful Response
     * @throws ApiError
     */
    public static createCollaboration(data: CollaborationsCreateCollaborationData): CancelablePromise<CollaborationsCreateCollaborationResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/agents/collaborations/create',
            body: data.requestBody,
            mediaType: 'application/json',
            errors: {
                422: 'Validation Error'
     ...
     * @param data The data for the request.
     * @param data.collaborationId
     * @param data.requestBody
     * @returns PostFindingResponse Successful Response
     * @throws ApiError
     */
    public static postFinding(data: CollaborationsPostFindingData): CancelablePromise<CollaborationsPostFindingResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/agents/collaborations/{collaboration_id}/findings',
            path: {
     ...
     * @param data The data for the request.
     * @param data.collaborationId
     * @returns AgentCollaborationPublic Successful Response
     * @throws ApiError
     */
    public static getCollaborationStatus(data: CollaborationsGetCollaborationStatusData): CancelablePromise<CollaborationsGetCollaborationStatusResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/agents/collaborations/{collaboration_id}/status',
            path: {
                collaboration_id: data.collaborationId
            },
            errors: {
     ...
     * @throws ApiError
     */
    public static getCollaborationBySession(data: CollaborationsGetCollaborationBySessionData): CancelablePromise<CollaborationsGetCollaborationBySessionResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/agents/collaborations/by-session/{session_id}',
            path: {
