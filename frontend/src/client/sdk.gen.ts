...
export class AgentAppMcpRoutesService {
    /**
     ...
     * @param data The data for the request.
     * @param data.agentId
     * @returns AppAgentRoutePublic Successful Response
     * @throws ApiError
     */
    public static listAgentAppMcpRoutes(data: AgentAppMcpRoutesListAgentAppMcpRoutesData): CancelablePromise<AgentAppMcpRoutesListAgentAppMcpRoutesResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/agents/{agent_id}/app-mcp-routes/',
            path: {
                agent_id: data.agentId
            },
            errors: {
     ...
     * @throws ApiError
     */
    public static createAgentAppMcpRoute(data: AgentAppMcpRoutesCreateAgentAppMcpRouteData): CancelablePromise<AgentAppMcpRoutesCreateAgentAppMcpRouteResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/agents/{agent_id}/app-mcp-routes/',
            path: {
     ...
     * @throws ApiError
     */
    public static updateAgentAppMcpRoute(data: AgentAppMcpRoutesUpdateAgentAppMcpRouteData): CancelablePromise<AgentAppMcpRoutesUpdateAgentAppMcpRouteResponse> {
        return __request(OpenAPI, {
            method: 'PUT',
            url: '/api/v1/agents/{agent_id}/app-mcp-routes/{route_id}',
            path: {
                agent_id: data.agentId,
     ...
     * @throws ApiError
     */
    public static deleteAgentAppMcpRoute(data: AgentAppMcpRoutesDeleteAgentAppMcpRouteData): CancelablePromise<AgentAppMcpRoutesDeleteAgentAppMcpRouteResponse> {
        return __request(OpenAPI, {
            method: 'DELETE',
            url: '/api/v1/agents/{agent_id}/app-mcp-routes/{route_id}',
            path: {
     ...
     * @param data.routeId
     * @param data.requestBody
     * @returns AppAgentRouteAssignmentPublic Successful Response
     * @throws ApiError
     */
    public static assignUsersToAgentRoute(data: AgentAppMcpRoutesAssignUsersToAgentRouteData): CancelablePromise<AgentAppMcpRoutesAssignUsersToAgentRouteResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/agents/{agent_id}/app-mcp-routes/{route_id}/assignments',
            path: {
                agent_id: data.agentId,
                route_id: data.routeId
            },
     ...
     * @throws ApiError
     */
    public static removeUserAssignmentFromAgentRoute(data: AgentAppMcpRoutesRemoveUserAssignmentFromAgentRouteData): CancelablePromise<AgentAppMcpRoutesRemoveUserAssignmentFromAgentRouteResponse> {
        return __request(OpenAPI, {
            method: 'DELETE',
            url: '/api/v1/agents/{agent_id}/app-mcp-routes/{route_id}/assignments/{user_id}',
            path: {
                agent_id: data.agentId,
                route_id: data.routeId,
                user_id: data.userId
...
export class AppAgentRoutesService {
    /**
     ...
     * @throws ApiError
     */
    public static listAppAgentRoutes(): CancelablePromise<AppAgentRoutesListAppAgentRoutesResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/admin/app-agent-routes/'
        });
    }
     ...
     * @throws ApiError
     */
    public static createAppAgentRoute(data: AppAgentRoutesCreateAppAgentRouteData): CancelablePromise<AppAgentRoutesCreateAppAgentRouteResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/admin/app-agent-routes/',
            body: data.requestBody,
     ...
     * @throws ApiError
     */
    public static getAppAgentRoute(data: AppAgentRoutesGetAppAgentRouteData): CancelablePromise<AppAgentRoutesGetAppAgentRouteResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/admin/app-agent-routes/{route_id}',
            path: {
                route_id: data.routeId
            },
            errors: {
     ...
     * @throws ApiError
     */
    public static updateAppAgentRoute(data: AppAgentRoutesUpdateAppAgentRouteData): CancelablePromise<AppAgentRoutesUpdateAppAgentRouteResponse> {
        return __request(OpenAPI, {
            method: 'PUT',
            url: '/api/v1/admin/app-agent-routes/{route_id}',
            path: {
     ...
     * @throws ApiError
     */
    public static deleteAppAgentRoute(data: AppAgentRoutesDeleteAppAgentRouteData): CancelablePromise<AppAgentRoutesDeleteAppAgentRouteResponse> {
        return __request(OpenAPI, {
            method: 'DELETE',
            url: '/api/v1/admin/app-agent-routes/{route_id}',
            path: {
     ...
     * @throws ApiError
     */
    public static assignUsersToRoute(data: AppAgentRoutesAssignUsersToRouteData): CancelablePromise<AppAgentRoutesAssignUsersToRouteResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/admin/app-agent-routes/{route_id}/assignments',
            path: {
                route_id: data.routeId
            },
            body: data.requestBody,
     ...
     * @throws ApiError
     */
    public static removeUserAssignment(data: AppAgentRoutesRemoveUserAssignmentData): CancelablePromise<AppAgentRoutesRemoveUserAssignmentResponse> {
        return __request(OpenAPI, {
            method: 'DELETE',
            url: '/api/v1/admin/app-agent-routes/{route_id}/assignments/{user_id}',
            path: {
                route_id: data.routeId,
                user_id: data.userId
            },
...
export class CliService {
     ...
     * @throws ApiError
     */
    public static getBuildContext(data: CliGetBuildContextData): CancelablePromise<CliGetBuildContextResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/cli/agents/{agent_id}/build-context',
            path: {
                agent_id: data.agentId
            },
            errors: {
     ...
     * @throws ApiError
     */
    public static uploadWorkspace(data: CliUploadWorkspaceData): CancelablePromise<CliUploadWorkspaceResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/cli/agents/{agent_id}/workspace',
            path: {
     ...
     * @throws ApiError
     */
    public static getWorkspaceManifest(data: CliGetWorkspaceManifestData): CancelablePromise<CliGetWorkspaceManifestResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/cli/agents/{agent_id}/workspace/manifest',
            path: {
                agent_id: data.agentId
            },
            errors: {
...
export class ExternalService {
     ...
     * @param data The data for the request.
     * @param data.workspaceId Optional workspace filter. When provided, limits the personal agents section to agents in this workspace. MCP shared agents and identity contacts are not filtered.
     ...
     *
     * Query params:
     * limit  — max results to return (default 100, capped at 200)
...
export class ExternalA2AService {
     ...
     * Return A2A AgentCard for the authenticated user's own agent.
     *
     * The caller must own the agent.  The a2a_config.enabled flag is NOT
     * required — the external surface is always available to the owner.
     *
     * Default protocol is v1.0; pass ``?protocol=v0.3`` for the legacy format.
     * @param data The data for the request.
     * @param data.agentId
     ...
     * Handle A2A JSON-RPC requests for the authenticated user's own agent.
     *
     * Supported methods (v1.0 PascalCase by default; pass ``?protocol=v0.3`` for
     * slash-case):
     * - SendStreamingMessage / message/stream  — SSE streaming response
     * - SendMessage         / message/send     — synchronous response
     * - GetTask             / tasks/get        — task status and history
     * - CancelTask          / tasks/cancel     — cancel a running task
     * - ListTasks           / tasks/list       — list tasks for this agent
     *
     * The a2a_config.enabled flag is NOT required.  Any agent owned by the
     * caller is reachable on this surface.
     * @param data The data for the request.
     * @param data.agentId
     * @param data.protocol
     * @returns unknown Successful Response
     ...
     * Well-known mirror of the AgentCard endpoint (standard A2A discovery path).
     * @param data The data for the request.
     * @param data.agentId
     * @param data.protocol
     * @returns unknown Successful Response
     ...
     * Return A2A AgentCard for a MCP Shared Agent route.
     *
     * The caller must still have an effective assignment for the route.
     * Card reflects the underlying agent but with route.name / route.trigger_prompt
     * and the URL rewritten into the external namespace.
     * @param data The data for the request.
     * @param data.routeId
     * @param data.protocol Protocol version: 'v1.0' (default) or 'v0.3'
     * @returns unknown Successful Response
     * @throws ApiError
     */
    public static getExternalRouteCard(data: ExternalA2aGetExternalRouteCardData): CancelablePromise<ExternalA2aGetExternalRouteCardResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/external/a2a/route/{route_id}/',
            path: {
                route_id: data.routeId
            },
            query: {
     ...
     * Handle A2A JSON-RPC requests for a MCP Shared Agent route.
     *
     * Sessions created via this endpoint are owned by the route's underlying
     * agent owner; the authenticated caller is tracked via session.caller_id.
     * session_metadata is stamped with app_mcp_route_id, app_mcp_route_type,
     * and app_mcp_match_method="external_direct".
     *
     * Route effectiveness is re-verified on every request (the caller must
     * still have an enabled assignment on an active route).
     * @param data The data for the request.
     * @param data.routeId
     * @param data.protocol
     * @returns unknown Successful Response
     * @throws ApiError
     */
    public static handleExternalRouteJsonrpc(data: ExternalA2aHandleExternalRouteJsonrpcData): CancelablePromise<ExternalA2aHandleExternalRouteJsonrpcResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/external/a2a/route/{route_id}/',
            path: {
     ...
     * @throws ApiError
     */
    public static getExternalRouteCardWellKnown(data: ExternalA2aGetExternalRouteCardWellKnownData): CancelablePromise<ExternalA2aGetExternalRouteCardWellKnownResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/external/a2a/route/{route_id}/.well-known/agent-card.json',
            path: {
                route_id: data.routeId
            },
            query: {
     ...
     * Return A2A AgentCard for an identity contact (a person).
     *
     * Person-level card: name=owner.full_name, description=owner.email, and one
     * AgentSkill per binding the caller is currently allowed to reach.  Requires
     * the caller to have at least one active+enabled IdentityBindingAssignment
     * for the owner.
     * @param data The data for the request.
     * @param data.ownerId
     * @param data.protocol Protocol version: 'v1.0' (default) or 'v0.3'
     ...
     * Handle A2A JSON-RPC requests for an identity contact.
     *
     * On the first message of a task the handler runs Stage 2 routing
     * (IdentityRoutingService.route_within_identity) to pick the binding/agent,
     * then creates an identity_mcp session owned by the identity owner with
     * session.identity_caller_id=current_user.id.  Subsequent messages that
     * carry the same task_id resume that session and re-verify the binding is
     * still active; a revoked binding surfaces as a standard "no longer active"
     * error code (-32004).
     * @param data The data for the request.
     * @param data.ownerId
     * @param data.protocol
...
export class TasksService {
     ...
     * @param data.id
     * @param data.requestBody
     * @returns SendAnswerResponse Successful Response
     * @throws ApiError
     */
    public static sendTaskEmailAnswer(data: TasksSendTaskEmailAnswerData): CancelablePromise<TasksSendTaskEmailAnswerResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/tasks/{id}/send-answer',
            path: {
                id: data.id
            },
            body: data.requestBody,
...
export class UserAppAgentRoutesService {
    /**
     * List User App Agent Routes
     * List personal routes and shared routes for the current user.
     * @returns UserAppAgentRoutesResponse Successful Response
     * @throws ApiError
     */
    public static listUserAppAgentRoutes(): CancelablePromise<UserAppAgentRoutesListUserAppAgentRoutesResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/users/me/app-agent-routes/'
        });
    }
     ...
     * @param data The data for the request.
     * @param data.requestBody
     * @returns UserAppAgentRoutePublic Successful Response
     * @throws ApiError
     */
    public static createUserAppAgentRoute(data: UserAppAgentRoutesCreateUserAppAgentRouteData): CancelablePromise<UserAppAgentRoutesCreateUserAppAgentRouteResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/users/me/app-agent-routes/',
            body: data.requestBody,
     ...
     * @throws ApiError
     */
    public static updateUserAppAgentRoute(data: UserAppAgentRoutesUpdateUserAppAgentRouteData): CancelablePromise<UserAppAgentRoutesUpdateUserAppAgentRouteResponse> {
        return __request(OpenAPI, {
            method: 'PUT',
            url: '/api/v1/users/me/app-agent-routes/{route_id}',
            path: {
                route_id: data.routeId
            },
            body: data.requestBody,
     ...
     * @throws ApiError
     */
    public static deleteUserAppAgentRoute(data: UserAppAgentRoutesDeleteUserAppAgentRouteData): CancelablePromise<UserAppAgentRoutesDeleteUserAppAgentRouteResponse> {
        return __request(OpenAPI, {
            method: 'DELETE',
            url: '/api/v1/users/me/app-agent-routes/{route_id}',
            path: {
     ...
     * @param data.isEnabled
     * @returns AppAgentRouteAssignmentPublic Successful Response
     * @throws ApiError
     */
    public static toggleAdminAssignment(data: UserAppAgentRoutesToggleAdminAssignmentData): CancelablePromise<UserAppAgentRoutesToggleAdminAssignmentResponse> {
        return __request(OpenAPI, {
            method: 'PATCH',
            url: '/api/v1/users/me/app-agent-routes/admin-assignments/{assignment_id}',
            path: {
...
export class UsersService {
     ...
     * @throws ApiError
     */
    public static generateGeneralAssistant(): CancelablePromise<UsersGenerateGeneralAssistantResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/users/me/general-assistant'
        });
    }
