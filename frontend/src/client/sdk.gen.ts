...
export class CliService {
     ...
     * @throws ApiError
     */
    public static getCredentials(data: CliGetCredentialsData): CancelablePromise<CliGetCredentialsResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/cli/agents/{agent_id}/credentials',
            path: {
                agent_id: data.agentId
            },
            errors: {
