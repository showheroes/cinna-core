...
export const ACPConnectorCreateSchema = {
    properties: {
        name: {
            type: 'string',
            maxLength: 255,
    ...
    type: 'object',
    required: ['name'],
    title: 'ACPConnectorCreate'
} as const;

export const ACPConnectorPublicSchema = {
    properties: {
        name: {
            type: 'string',
            maxLength: 255,
    ...
    type: 'object',
    required: ['name', 'id', 'agent_id', 'owner_id', 'created_at', 'updated_at'],
    title: 'ACPConnectorPublic'
} as const;

export const ACPConnectorUpdateSchema = {
    properties: {
        name: {
            anyOf: [
                {
    ...
    type: 'object',
    title: 'ACPConnectorUpdate'
} as const;

export const ACPConnectorsPublicSchema = {
    properties: {
        data: {
            items: {
                '$ref': '#/components/schemas/ACPConnectorPublic'
            },
            type: 'array',
            title: 'Data'
        },
    ...
    type: 'object',
    required: ['data', 'count'],
    title: 'ACPConnectorsPublic'
} as const;

export const ACPTokenCreateSchema = {
    properties: {
        label: {
            type: 'string',
            maxLength: 255,
    ...
    type: 'object',
    required: ['label'],
    title: 'ACPTokenCreate'
} as const;

export const ACPTokenCreatedSchema = {
    properties: {
        id: {
            type: 'string',
            format: 'uuid',
    ...
    type: 'object',
    required: ['id', 'connector_id', 'prefix', 'label', 'revoked', 'expires_at', 'created_at', 'last_used_at', 'token'],
    title: 'ACPTokenCreated',
    description: 'The bearer token is returned only when it is minted.'
} as const;

export const ACPTokenPublicSchema = {
    properties: {
        id: {
            type: 'string',
            format: 'uuid',
    ...
    type: 'object',
    required: ['id', 'connector_id', 'prefix', 'label', 'revoked', 'expires_at', 'created_at', 'last_used_at'],
    title: 'ACPTokenPublic'
} as const;

export const ACPTokensPublicSchema = {
    properties: {
        data: {
            items: {
                '$ref': '#/components/schemas/ACPTokenPublic'
            },
            type: 'array',
            title: 'Data'
        },
