...
Same infrastructure as agents/conftest.py — session proxy, environment adapter,
background task collector, and external service mocks. Additionally mocks
AgentService.create_agent_task so collaboration creation can run without a
full agent-env dispatch chain.
"""
import pytest
