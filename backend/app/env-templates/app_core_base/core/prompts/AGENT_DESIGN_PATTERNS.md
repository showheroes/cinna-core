<!-- Generated from docs/local_agent_kit/guides/13-design-patterns.md by `make sync-platform-knowledge`. Do not edit this copy: edit the kit guide and re-run the sync. -->
