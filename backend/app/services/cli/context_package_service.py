...
class ContextPackageService:
    ...
    def _render_index() -> str:
        ...
        return (
            ...
            "| `guides/` | Worked walkthroughs — stand up a delegating multi-agent network, expose an agent as a REST API, author an agent's prompts & description, build a skill whose script needs a credential, and turn a user's improvement request into a fix. |\n"
            ...
            "bulk write: `cinna agent prompts pull <agent>`, edit the files under\n"
            "`prompts/<agent-slug>/`, `cinna agent prompts push <agent>`.\n"
            "\n"
            "When a skill's script needs a credential, read\n"
            "`guides/skills-with-credentials.md` before writing the script.\n"
            "\n"
